      ...
      <section className="containerfcv mt-64">
        ...
        <div className="year">
          ...
          <FormControl fullWidth className="year-field">
            ...
            >
              {years.map((year) => (
                <MenuItem key={`project-menu-${year}`} value={year}>
                  {year}
                </MenuItem>
              ))}
            </Select>
        ...
        <ul className="projects-icons-home list-projects mb-32">
          {sectorsData.map((sector) => (
            <div key={`sector-element-${sector.S_ID}`} className="box-projects">
              <li
              ...
              >
                <ListItemButton>
                  <ListItemIcon sx={{height: "35px"}}>
                    <img src={project.ICON} alt={`icono de ${project.SECTOR_NAME_SPA}`} />
                  </ListItemIcon>
