...
export function HomeProjectsSection() {
  const projectsData = ProjectsInfo().ProjectsInfo;
  const sectorsData = SectorsInfo();
  console.log("🚀 ~ file: HomeProjectsSection.jsx:23 ~ HomeProjectsSection ~ sectorsData:", sectorsData)
  ...
  return (
    <>
      <section className="container mt-64">
          ...
          <FormControl fullWidth>
            ...
            >
              {projectsData.projects.map((project) => (
                <MenuItem
                  key={`project-menu-${project.PR_ID}`}
                  value={parseInt(project.YEAR)}
                >
                  {project.YEAR}
                </MenuItem>
              ))}
        ...
        <ul className="icons-projects list-projects">
          {sectorsData.map((sector) => (
            <div
              key={`sector-element-${sector.S_ID}`}
              className="box-icons-projects text-icons"
            >
              <li key={`sector-list${sector.S_ID}`}>
                <svg
                  key={`sector-img${sector.S_ID}`}
                  id="Capa_2"
              ...
              <label key={`sector-label${sector.S_ID}`} className="text-icons mt-16">
