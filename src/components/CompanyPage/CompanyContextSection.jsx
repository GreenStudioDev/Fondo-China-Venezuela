...
export function CompanyContextSection() {
  ...
  let { C_ID } = useParams();
   ...
   const infoCompany = [];
  infoCompany.push(companyData.find((info) => info.COMPANY_ID === C_ID));
  const CompanySectors = [];
  CompanySectors.push(companySect.filter((info) => info.COMPANY_ID === C_ID));
  ...
  return (
    <>
      ...
      <div className="box-header-company">
          ...
          <p>
            {infoCompany[0]?.DESCRIPTION_OF_OPERATIONS_IN_VENEZUELA_SPA}
          </p>
              ...
              <ul className="icons-projects-sectores">
                ...
                <div className="text-align">
                  <div className="box-icons-project text-icons-project">
                    <li>
                      <img style={{height: "73px"}} src={sector.ICON} alt="" />
                    </li>
                  </div>
